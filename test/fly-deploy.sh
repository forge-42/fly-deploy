...
declare -rg INPUT_ATTACH_POSTGRES="${INPUT_ATTACH_POSTGRES:-}"
echo "INPUT_ATTACH_POSTGRES=$INPUT_ATTACH_POSTGRES"
...
declare -rg GITHUB_REPOSITORY_OWNER="${GITHUB_REPOSITORY_OWNER:-forge42dev}"
echo "GITHUB_REPOSITORY_OWNER=$GITHUB_REPOSITORY_OWNER"
declare -rg GITHUB_REPOSITORY="${GITHUB_REPOSITORY:-${GITHUB_REPOSITORY_OWNER}/base-stack-example}"
...
continue_on_any_key "Continue with running the action?"
