...
declare -rg INPUT_APP_NAME_SUFFIX="${INPUT_APP_NAME_SUFFIX:-}"
echo "INPUT_APP_NAME_SUFFIX=$INPUT_APP_NAME_SUFFIX"
...
declare -rg INPUT_DEPLOY_WAIT_TIMEOUT="${INPUT_DEPLOY_WAIT_TIMEOUT:-}"
echo "INPUT_DEPLOY_WAIT_TIMEOUT=$INPUT_DEPLOY_WAIT_TIMEOUT"
declare -rg INPUT_DEPLOY_IMMEDIATELY="${INPUT_DEPLOY_IMMEDIATELY:-}"
echo "INPUT_DEPLOY_IMMEDIATELY=$INPUT_DEPLOY_IMMEDIATELY"
continue_on_any_key
